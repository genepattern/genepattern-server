...
public class JXTreeTable extends JTable {
    ...
    * @param tsl the TreeSelectionListener that will be notified when a node is selected or deselected (a "negative  selection")
    */
  ...
  //  public void setColumnMargin(int columnMargin) {
   ...
   // }
    ...
    public Component prepareRenderer(TableCellRenderer renderer, int row,
        ...
        return applyRenderer(super.prepareRenderer(renderer, row, column),
            adapter); 
    }
   ...
   //     renderer.collapseAll();
    ...
    static class TreeTableCellRenderer extends JTree implements
        ...
        public void paint(Graphics g) {
            ...
            g.translate(0, -(rowMargin + (rowMargin >> 1) + (rowMargin % 2) +
