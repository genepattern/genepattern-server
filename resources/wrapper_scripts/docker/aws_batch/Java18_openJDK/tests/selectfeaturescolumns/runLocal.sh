...
docker run -v "$PWD"/job_12/:/jobdir/job_12 -v "$PWD"/src:/tasklib/sfc -v "$PWD"/data:/data -w /jobdir/job_12 liefeld/java8_openjdk_cli java -cp /tasklib/sfc/SelectFeaturesColumns.jar:/tasklib/sfc/gp-modules.jar org.genepattern.modules.selectfeaturescolumns.SelectFeaturesColumns /data/all_aml_train.gct /jobdir/job_12/testout.gct -t1-2
