...
TASKLIB=$TEST_ROOT/Perl520/tests/convertlineendings/src
INPUT_FILE_DIRECTORIES=$TEST_ROOT/Perl520/tests/convertlineendings/data
JOB_DEFINITION_NAME="Perl520_Generic"
JOB_ID=gp_job_AffyST_ConvertLineEndings_$1
JOB_QUEUE=TedTest
S3_ROOT=s3://moduleiotest
WORKING_DIR=$TEST_ROOT/Perl520/tests/convertlineendings/job_1

COMMAND_LINE="perl $TASKLIB/to_host.pl $INPUT_FILE_DIRECTORIES/man2.cvt.txt anOutputFile"
