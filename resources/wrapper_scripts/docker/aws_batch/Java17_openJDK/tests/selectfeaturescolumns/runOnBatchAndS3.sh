...
#
TEST_ROOT=/Users/liefeld/GenePattern/gp_dev/genepattern-server/resources/wrapper_scripts/docker/aws_batch/Java17_openjdk/tests
...
JOB_ID=gp_job_AffyST_Java17_openjdk_SFC_$1
JOB_QUEUE=TedTest
