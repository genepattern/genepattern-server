...
public class AnalysisManager {
   ...
   // To make Singleton
     ...
     *  @param AnalysisTask
     */
    public  synchronized String startNewAnalysisTask(AnalysisTask task, int taskID) throws OmnigeneException{
       // jgould: was previously used to create new instances of AnalysisTask based on taskName
     ...
     */
    public synchronized String startNewAnalysisTask(int taskID) throws OmnigeneException {
        // jgould: was previously used to create new instances of AnalysisTask based on taskName
        return AnalysisTask.getInstance().getTaskName();
    }
