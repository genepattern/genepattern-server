...
public class ParameterInfo implements Serializable {
    ...
    public boolean isOutputFile(){
        if(this.attributes!=null && this.attributes.containsKey(this.TYPE) && this.attributes.containsKey(this.MODE)){
            String type = (String)this.attributes.get(this.TYPE);
            String mode = (String)this.attributes.get(this.MODE);
            if(type.equals(this.FILE_TYPE)&&mode.equals(this.OUTPUT_MODE)){
                return true;
            }
        }
        return false;
    ...
    public String getLabel(){
        String label="";
        if(this.attributes!=null && this.attributes.containsKey(this.LABEL)){
            label = (String)this.attributes.get(this.LABEL);
        }
        return label;
    }
