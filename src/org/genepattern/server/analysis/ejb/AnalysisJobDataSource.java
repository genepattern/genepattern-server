...
/**
 * AnalysisJobDataSource.java
 * This interface used by AnalysisDAO
...
public interface AnalysisJobDataSource {
     ...
     * @throws OmnigeneException Error in db
     * @throws RemoteException Error in service
     * @return task id
     */
    public  int getTaskIDByName(String name, String userID) throws OmnigeneException, RemoteException ;
    ...
    public boolean resetPreviouslyRunningJobs() throws OmnigeneException, RemoteException;
