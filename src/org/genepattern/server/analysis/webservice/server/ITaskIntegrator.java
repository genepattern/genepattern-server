...
public interface ITaskIntegrator {
    ...
    * @param privacy               One of GPConstants.ACCESS_PUBLIC or
    ...
    * @param privacy               One of GPConstants.ACCESS_PUBLIC or
    *        GPConstants.ACCESS_PRIVATE
    * @param recursive		   Installs dependent tasks from same zip file (zip of zips)
    * @return The LSID of the task
    * @throws WebServiceException If an error occurs
    */
    ...
    * 
    * @param dataHandler                   The zip file
    * @param privacy               One of GPConstants.ACCESS_PUBLIC or
    *        GPConstants.ACCESS_PRIVATE
    * @return The LSID of the task
    * @throws WebServiceException If an error occurs
    ...
    * will be created.
    * 
    * @param accessId                 One of GPConstants.ACCESS_PUBLIC or
    *        GPConstants.ACCESS_PRIVATE
    * @param taskName                 The name of the task
    * @param description              The description
    * @param parameterInfoArray       The input parameters
    * @param taskAttributes           Attributes that go in the task manifest
    *        file
    * @param dataHandlers             Holds the uploaded files
    * @param fileNames                The names of the files on the client
    * @return The LSID of the task
    * @exception WebServiceException  If an error occurs
    */
