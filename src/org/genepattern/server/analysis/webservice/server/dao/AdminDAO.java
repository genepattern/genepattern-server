...
public interface AdminDAO {
   /**
    *  Gets the task id with the given lsid or task name. If <code>lsidOrTaskName</code>
    *  is a valid LSID with a version, then it is unambiguous which task to
    *  retrieve. If <code>lsidOrTaskName</code> is a valid LSID with no
    *  version, the latest version for the task is retrieved. If <code>lsidOrTaskName</code>
    *  is a task name, the latest version of the task with the nearest
    *  authority is selected. The nearest authority is the first match in the
    *  sequence: local authority,ÊBroad authority, other authority.
    *
    * @param  username                  The username. If <code>null</code> then privacy is not enforced if <code>lsidOrTaskName</code> is a valid LSID. This is necessary because GenePatternAnalysisTask passes <code>null</code> for username in some cases, such as deleteTask. FIXME
    * @param  lsidOrTaskName            A task name or LSID
    * @return                           The task id or -1 if not
    *      found
    * @exception  AdminDAOSysException  If an error occurs
    */
  ...
  /**
    ...
    * @param  lsidOrTaskName            A task name or LSID
    * @return                           The task or <code>null</code> if not
    *      found
    * @exception  AdminDAOSysException  If an error occurs 
    */
    ...
    * @exception  AdminDAOSysException  If an error occurs
    */
   public TaskInfo[] getAllTasks(String username)
          throws AdminDAOSysException;
    ...
    * @exception  AdminDAOSysException  If an error occurs or if the given taskId is not found.
    */
    ...
    * @exception  AdminDAOSysException  If an error occurs
    */
   public TaskInfo[] getAllTasksAllTypes()
          throws AdminDAOSysException;
}
