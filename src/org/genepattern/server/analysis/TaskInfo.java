...
public class TaskInfo implements Serializable {
    ...
    private String taskName="",description="",taskClassName="",parameter_info="";
    ...
    public TaskInfo(int taskID, String taskName , String description,String parameter_info,String taskClassName) {
        this(taskID, taskName, description, parameter_info, taskClassName, null);
    }

    public TaskInfo(int taskID, String taskName, String description,String parameter_info,String taskClassName, TaskInfoAttributes taskInfoAttributes) {
        this(taskID, taskName, description, parameter_info, taskClassName, taskInfoAttributes, null, 0);
    }
    
    public TaskInfo(int taskID, String taskName, String description,String parameter_info,String taskClassName, TaskInfoAttributes taskInfoAttributes,String userId, 
                    int accessId) {
        this.taskID=taskID;
	...
	if (! (otherThing instanceof TaskInfo) || otherThing == null) return false;
	TaskInfo other = (TaskInfo)otherThing;
	return	getUserId().equals(other.getUserId()) &&
		getAccessId() == other.getAccessId() &&
		((getTaskInfoAttributes() == null && other.getTaskInfoAttributes() == null) ||
		 (getTaskInfoAttributes() != null && other.getTaskInfoAttributes() != null &&
		  getTaskInfoAttributes().equals(other.getTaskInfoAttributes()))) &&
		getName().equals(other.getName()) &&
		getID() == other.getID() &&
		getDescription().equals(other.getDescription()) &&
		((getParameterInfo() == null && other.getParameterInfo() == null) ||
		 (getParameterInfo() != null && other.getParameterInfo() != null &&
		  getParameterInfo().equals(other.getParameterInfo()))) &&
