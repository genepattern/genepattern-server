...
public class HibernateUtil {
	...
	/**
	 * If the current session has an open transaction commit it and close the
	 * current session, otherwise do nothing.
	 * 
	 */
	...
	/**
	 * If the current session has an open transaction roll it back and close the
	 * current session, otherwise do nothing.
	 * 
	 */
