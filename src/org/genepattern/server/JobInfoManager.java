...
public class JobInfoManager {
    ...
    public static String createVisualizerAppletTag(String documentCookie, JobInfoWrapper jobInfoWrapper, TaskInfo taskInfo) 
    {
        ...
        appletTag.append(" name=\""+jobInfoWrapper.getVisualizerAppletName()+"\" id=\""+jobInfoWrapper.getVisualizerAppletId()+"\" code=\"" 
                ...
                + "\" archive=\"runVisualizer.jar,commons-httpclient.jar,commons-codec-1.3.jar\" codebase=\"/gp/downloads\" width=\"600\" height=\"200\" alt=\"Your browser can not run applets\">");
