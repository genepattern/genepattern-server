...
public class UpdateTaskHandler extends RequestHandler {
	 ...
	 */
	public UpdateTaskHandler(int taskID, ParameterInfo[] parameterInfoArray,
			String taskInfoAttributeString, String user_id, int access_id) {
		this._taskID = taskID;
	...
	public int executeRequest() throws OmnigeneException {
		...
		try {
			...
			//Invoke EJB function
			updatedRecord = ds.updateTask(_taskID, parameter_info,
					_taskInfoAttributeString, _user_id, _access_id);
