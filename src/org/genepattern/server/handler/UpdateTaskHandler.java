...
/**
 * <p>Title: UpdateTaskHandler.java </p>
 * <p>Description: Updates the parameters of an existing task</p>
 * @author Hui Gong
 * @version 1.0
 */
...
public class UpdateTaskHandler extends RequestHandler {
     ...
     */
   public UpdateTaskHandler(int taskID, ParameterInfo[] parameterInfoArray, String taskInfoAttributeString, String user_id, int access_id) {
        this._taskID=taskID;
