 ...
 */
public class GenomeSpaceClient {
	private static Logger log = Logger.getLogger(GenomeSpaceClient.class);
    ...
    private GenomeSpaceFile buildDirectory(Object gsSessionObject, GSDirectoryListing dir, GSFileMetadata metadata) {
        ...
        GenomeSpaceFile directoryFile = (GenomeSpaceFile) GenomeSpaceFileHelper.createFile(gsSession, metadata.getUrl(), metadata);
        ...
        for (GSFileMetadata i : dir.findDirectories()) {
            GenomeSpaceFile aFile = (GenomeSpaceFile) GenomeSpaceFileHelper.createFile(gsSession, i.getUrl(), i);
    ...
    public Object obtainMetadata(Object gsSessionObject, URL gsUrl) throws GenomeSpaceException {
        ...
        // Declare necessary objects
        String path = GenomeSpaceFileHelper.urlToPath(gsUrl);
        DataManagerClient dmClient = gsSession.getDataManagerClient();
