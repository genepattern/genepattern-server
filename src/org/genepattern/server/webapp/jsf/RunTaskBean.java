...
public class RunTaskBean {
    ...
    // This is an odd class for this variable,
    // but RunTaskBean is the backing bean for the home page.
    ...
    public void setShowParameterDescriptions(boolean b) {
        ...
        userDao.setProperty(UIBeanHelper.getUserId(), "show.parameter.descriptions", String.valueOf(b));
    }
    ...
    public void setTask(String taskNameOrLsid) {
        ...
        try {
            ...
            taskInfo = adminClient.getTask(taskNameOrLsid);
        } 
                        ...
                        for (ParameterInfo outputParameter : outputFileParameters) {
                            if (outputParameter.isOutputFile()) {
                                ...
                                if (inputParameterNames != null && inputParameterNames.size() >= 1) {
                                    // XXX use first match if kind matches more than one input parameter
