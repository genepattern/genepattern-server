    ...
    public Response authorize(@Context HttpServletRequest request)
        ...
        try {
            ...
            OAuthASResponse.OAuthAuthorizationResponseBuilder builder = OAuthASResponse
                    .authorizationResponse(request, HttpServletResponse.SC_MOVED_TEMPORARILY);
            ...
            final OAuthResponse response = OAuthASResponse.errorResponse(HttpServletResponse.SC_MOVED_TEMPORARILY)
                    .error(e)
