 ...
 * </p>
 * <ul>
 * <li>If the specified String is null, return a <code>null</code>.
 * Otherwise, trim leading and trailing whitespace before proceeding.</li>
 ...
 * pattern will be used to parse, and the <code>type</code>,
 ...
 * <li>If a <code>timezone</code> has been specified, it must be passed to
 * the underlying <code>DateFormat</code> instance. Otherwise the "GMT"
 * timezone is used.</li>
 ...
 * <li>If a <code>pattern</code> has been specified, its syntax must conform
 * the rules specified by <code>java.text.SimpleDateFormat</code>. Such a
 * pattern will be used to format, and the <code>type</code>,
 * <code>dateStyle</code>, and <code>timeStyle</code> properties will be
 * ignored.</li>
 * <li>If a <code>pattern</code> has not been specified, formatting will be
 * based on the <code>type</code> property, which includes a date value, a
...
public class DateTimeConverter implements Converter, StateHolder {
     ...
     * conversion to <code>Date</code> fails. The message format string for
     ...
     * The message identifier of the
     * {@link javax.faces.application.FacesMessage} to be created if the
     * conversion to <code>Time</code> fails. The message format string for
     * this message may optionally include the following placeholders:
     * <ul>
     * <li><code>{0}</code> replaced by the unconverted value.</li>
     * <li><code>{1}</code> replaced by an example value.</li>
     ...
     * The message identifier of the
     * {@link javax.faces.application.FacesMessage} to be created if the
     * conversion to <code>DateTime</code> fails. The message format string
     ...
     * The message identifier of the
     * {@link javax.faces.application.FacesMessage} to be created if the
     * conversion of the <code>DateTime</code> value to <code>String</code>
    ...
    /**
     * <p>
     * Return the style to be used to format or parse dates. If not set, the
     * default value, <code>default<code>, is returned.</p>
     */
     ...
     * <code>default</code>, <code>short</code>, <code>medium</code>,
     * <code>long</code>, and <code>full</code>. An invalid value will
    ...
    /**
     * <p>
     * Return the <code>Locale</code> to be used when parsing or formatting
    ...
    /**
     * <p>
     * Set the <code>Locale</code> to be used when parsing or formatting dates
     * and times. If set to <code>null</code>, the <code>Locale</code>
    ...
    /**
     * <p>
     * Return the format pattern to be used when formatting and parsing dates
     * and times.
     * </p>
     */
    ...
    /**
     * <p>
     * Set the format pattern to be used when formatting and parsing dates and
     * times. Valid values are those supported by
    ...
    /**
     * <p>
     * Return the style to be used to format or parse times. If not set, the
     * default value, <code>default</code>, is returned.
     * </p>
     */
    ...
    /**
     * <p>
     * Return the <code>TimeZone</code> used to interpret a time value. If not
     * explicitly set, the default time zone of <code>GMT</code> returned.
     * </p>
     */
    ...
    /**
     * <p>
     * Return the type of value to be formatted or parsed. If not explicitly
     * set, the default type, <code>date</code> is returned.
     * </p>
     */
     ...
     * <code>both</code>, <code>date</code>, or <code>time</code>. An
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        try {
            ...
            if (type.equals("date")) {
                throw new ConverterException(MessageFactory.getMessage(context, DATE_ID, new Object[] { value,
                        parser.format(new Date(System.currentTimeMillis())),
                        MessageFactory.getLabel(context, component) }));
            } else if (type.equals("time")) {
                throw new ConverterException(MessageFactory.getMessage(context, TIME_ID, new Object[] { value,
                        parser.format(new Date(System.currentTimeMillis())),
                        MessageFactory.getLabel(context, component) }));
            } else if (type.equals("both")) {
                throw new ConverterException(MessageFactory.getMessage(context, DATETIME_ID, new Object[] { value,
                        parser.format(new Date(System.currentTimeMillis())),
                        MessageFactory.getLabel(context, component) }));
            }
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        ...
        try {
            ...
            throw new ConverterException(MessageFactory.getMessage(context, STRING_ID, new Object[] { value,
