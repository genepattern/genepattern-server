...
public class GenePatternAnalysisTask implements IGPConstants {
    ...
    public static AnalysisJobService getDS() throws OmnigeneException {
    ...
    public static List getTasks(String userID) throws OmnigeneException {
        List vTasks = getDS().getTasks(userID); // get vector of TaskInfos
        return vTasks;
    }
    ...
    public static JobInfo createPipelineJob(String userID, String parameter_info, String pipelineName, String lsid)
        ...
        JobInfo jobInfo = AnalysisJobService.getInstance().createTemporaryPipeline(userID, parameter_info, pipelineName, lsid);
        return jobInfo;
    }
