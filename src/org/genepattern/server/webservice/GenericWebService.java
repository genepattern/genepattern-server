 ...
 * <p>
 * <code>GenericWebService</code> implements the <code>WebService</code> interface.  
 * <code>GenericWebService</code> may be directly extended for more specific domain
 * web services.
 *
...
public abstract class GenericWebService implements WebService
{
    ...
    /**
     * Constructs a GenericWebService object with the specified scheme name
     * and scheme version.
     *
     * @param scheme a <code>String</code> object containing the scheme name
     * @param version a <code>float</code> containing the scheme version
     */
     ...
     *
     * @return a <code>String</code> containing information about this web service.
     */
