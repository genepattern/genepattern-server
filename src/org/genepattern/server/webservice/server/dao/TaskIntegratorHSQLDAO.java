 ...
 *         should move here
 */
public class TaskIntegratorHSQLDAO extends BaseDAO {

    private static Category log = Logger.getInstance(TaskIntegratorHSQLDAO.class);

    protected SuiteInfo suiteInfoFromResultSet(ResultSet resultSet) throws SQLException, AdminDAOSysException {
