...
public class OdfParser {
    ...
    private String readLine() throws IOException {
        ...
        if (line != null && line.trim().startsWith(COMMENT)) {
            return readLine();
        } else if (line != null && line.trim().equals("")) { // skip blank
                                                                // lines
            return readLine();
        }
        return line;
     ...
     */
    public boolean canDecode(InputStream is) throws IOException {// delete
                                                                    // this
        // method??
        this.reader = new LineNumberReader(new InputStreamReader(is));
    ...
    void parseHeader() throws ParseException, IOException {
        ...
        for (int i = 0; i < headerLines; i++) {
            ...
            if (equalsIndex > 0 && equalsIndex < semiIndex) {
                ...
                throw new ParseException("Invalid header " + line + " on line "
                        + reader.getLineNumber());
            }
