...
public class XmlJavaObjectParser extends AbstractDataParser {
     ...
     *
     */
    public DataObjector parse(InputStream in, String name) throws IOException, ParseException {
    ...
    public String getFullHeader(InputStream in) throws IOException, ParseException {
