...
/**
 * Converts a Dataset object to a FeaturesetProperties oject to encode it as a
 * odf file format.
 * 
 * @author kohm
 */
public class DatasetEncoder extends FeaturesetPropertiesEncoder implements
		Encoder {
	 ...
	 * @throws IOException
	 *             if an problem occurs durring I/O
	 */
