 ...
 * @author  kohm
 */
public class XmlSerializer implements ExceptionListener, org.genepattern.io.encoder.Encoder {
     ...
     * @param object DataModel for the analysis UI
     * @param fileName the xml file name
     * @throws IOException 
     */
    public static final void saveData(final Object object, final File file) throws IOException {
...
//    }
     ...
     * FIXME not smart enough to determine if it can really serialize something
     */
    public boolean canEncode(final DataObjector data) {
        return data.isMutable();//just a guess that if it is mutable then has setters as well as getters
    }
