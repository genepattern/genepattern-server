 ...
 * @author kohm
 */
public class TemplatePropertiesWrapper extends AbstractObject implements
	...
	public Object getValueAt(final int row, final int col) {
		...
		default:
			throw new ArrayIndexOutOfBoundsException("Column index (" + col
					+ ") out of bounds must be 0 - " + getColumnCount() + "!");
		}
	}
	...
	*/
	...
	// fields
	/** the descriptions */
	protected static final String[] COL_DESCS = new String[] {
			"The Label of the sample", "Identification value" };
