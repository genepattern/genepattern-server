    ...
    class MyHandler implements IOdfHandler {
        ...
        public void data(int i, int j, String s)
            ...
            if (j == rowNamesColumn) {
                ...
                if (expressionHandler != null) {
                    expressionHandler.rowMetaData(i, 0, s);
                }
            } else {
                try {
                    if (expressionHandler != null) {
        ...
        public void endHeader() throws org.genepattern.io.ParseException {
            ...
            if (rowNamesColumn > 0) {// for compatibilty with other odf
                // parser
            ...
            if (expressionHandler != null) {
                String[] rowMetaData = rowDescriptionsColumnSpecified ? new String[] { "description" }
                        : new String[] {};
                expressionHandler.init(rows, actualColumns, rowMetaData,
                        new String[] { "description" }, new String[] {});
            }
            if (expressionHandler != null) {
                for (int j = 0; j < actualColumns; j++) {
                    ...
                    if (columnDescriptions != null) {
                        expressionHandler.columnMetaData(j, 0,
