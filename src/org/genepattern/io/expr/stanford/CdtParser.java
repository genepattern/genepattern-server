...
public class CdtParser implements IExpressionDataParser {
    ...
    protected void _parse(LineNumberReader infile) throws IOException, org.genepattern.io.ParseException {
        ...
        if (count != columns)
        {
            throw new org.genepattern.io.ParseException("Unexpected number of columns on line " + infile.getLineNumber());
        }
        
        // next just loop through lines and see if eweight, EORDER lines are there
    ...
    protected void parseLine(String line) {
        ...
        if (tokens.hasMoreTokens())
        { // this will accomidate for files where delimiter is couted twice on currenet os
