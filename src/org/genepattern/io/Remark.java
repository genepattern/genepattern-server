...
public class Remark extends AbstractObject{
    ...
    protected static final String removeMarker(final String note, final String marker) {
        if(note == null)
            throw new NullPointerException("The text of the note cannot be null!");
    ...
    /** this is a reminder that data objects must override toString() */
     public String toString() {
        //return "Remark [\""+getName() + "\" Location: \"" + getLocation()+"\"]";
         return getName();
     }
