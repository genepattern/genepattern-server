...
public class OmnigeneException extends Exception
{
   ...
   private String code = null;	
    ...
    /**
        * Constructs a <code>OmnigeneException</code> with the specified detail message.
        *
    ...
    /**
     * Constructs an <code>OmnigeneException</code> class
     * with the specified detail message.
     *
     * @param   errNo   the Omnigene error number.
     */
     ...
     *
     * @param   errNo   the Omnigene error number.
     * @param   errMsg  the detail message associated with this error number.
     */
