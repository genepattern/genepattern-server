...
public class TaskIntegratorSoapBindingStub extends org.apache.axis.client.Stub {
    ...
    public java.lang.String cloneTask(java.lang.String taskName, java.lang.String cloneName) throws java.rmi.RemoteException, org.genepattern.webservice.WebServiceException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
