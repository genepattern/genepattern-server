...
public class AnalysisSoapBindingStub extends org.apache.axis.client.Stub {
	...
	static {
		...
		oper.setReturnType(new javax.xml.namespace.QName("Analysis",
				"TaskInfoArray"));
		...
		oper.addParameter(new javax.xml.namespace.QName("", "taskID"),
				new javax.xml.namespace.QName(
						"http://www.w3.org/2001/XMLSchema", "int"), int.class,
				org.apache.axis.description.ParameterDesc.IN, false, false);
		oper.addParameter(new javax.xml.namespace.QName("", "parmInfo"),
				new javax.xml.namespace.QName("Analysis", "ParmInfoArray"),
				ParameterInfo[].class,
				org.apache.axis.description.ParameterDesc.IN, false, false);
		oper.addParameter(new javax.xml.namespace.QName("", "dataHandler"),
				new javax.xml.namespace.QName("http://xml.apache.org/xml-soap",
						"DataHandler"), javax.activation.DataHandler.class,
				org.apache.axis.description.ParameterDesc.IN, false, false);
		oper
				.setReturnType(new javax.xml.namespace.QName("Analysis",
						"JobInfo"));
		...
		oper.addParameter(new javax.xml.namespace.QName("", "taskID"),
				new javax.xml.namespace.QName(
						"http://www.w3.org/2001/XMLSchema", "int"), int.class,
				org.apache.axis.description.ParameterDesc.IN, false, false);
		oper.addParameter(new javax.xml.namespace.QName("", "parameters"),
				new javax.xml.namespace.QName("Analysis", "ParmInfoArray"),
				ParameterInfo[].class,
				org.apache.axis.description.ParameterDesc.IN, false, false);
		oper.addParameter(new javax.xml.namespace.QName("", "files"),
				new javax.xml.namespace.QName("http://xml.apache.org/xml-soap",
		...
		oper.addParameter(new javax.xml.namespace.QName("", "jobId"),
				new javax.xml.namespace.QName(
						"http://www.w3.org/2001/XMLSchema", "int"), int.class,
				org.apache.axis.description.ParameterDesc.IN, false, false);
		oper.addParameter(new javax.xml.namespace.QName("", "fileNames"),
				new javax.xml.namespace.QName(
						"http://localhost:8080/gp/services/Analysis",
		...
		oper.addParameter(new javax.xml.namespace.QName("", "scheme"),
				new javax.xml.namespace.QName(
						"http://www.w3.org/2001/XMLSchema", "string"),
		...
		oper.setReturnQName(new javax.xml.namespace.QName("",
				"getEncodingSchemeVersionReturn"));
		oper.setStyle(org.apache.axis.enum.Style.RPC);
		oper.setUse(org.apache.axis.enum.Use.ENCODED);
		_operations[13] = oper;
		...
		oper.addParameter(new javax.xml.namespace.QName("", "version"),
				new javax.xml.namespace.QName(
						"http://www.w3.org/2001/XMLSchema", "float"),
	...
	public TaskInfo[] getTasks() throws java.rmi.RemoteException,
			org.genepattern.webservice.WebServiceException {
		if (super.cachedEndpoint == null) {
		...
		_call.setOperationName(new javax.xml.namespace.QName(
				"http://server.webservice.server.genepattern.org", "getTasks"));
		...
		if (_resp instanceof java.rmi.RemoteException) {
			...
			try {
				...
				return (TaskInfo[]) org.apache.axis.utils.JavaUtils.convert(
						_resp, TaskInfo[].class);
			}
		}
	}
	...
	public void deleteJob(int jobId) throws java.rmi.RemoteException,
		...
		java.lang.Object _resp = _call
				.invoke(new java.lang.Object[] { new java.lang.Integer(jobId) });
	...
	public JobInfo submitJob(int taskID, ParameterInfo[] parameters,
			java.util.HashMap files) throws java.rmi.RemoteException,
			org.genepattern.webservice.WebServiceException {
		if (super.cachedEndpoint == null) {
			throw new org.apache.axis.NoEndPointException();
		}
		...
		setAttachments(_call);
		java.lang.Object _resp = _call.invoke(new java.lang.Object[] {
				new java.lang.Integer(taskID), parameters, files });
		...
		if (_resp instanceof java.rmi.RemoteException) {
			...
			try {
				...
				return (JobInfo) org.apache.axis.utils.JavaUtils.convert(_resp,
						JobInfo.class);
			}
		}
	}
	...
	public void deleteJobOutputFiles(int jobId, java.lang.String[] fileNames)
			throws java.rmi.RemoteException {
		if (super.cachedEndpoint == null) {
			throw new org.apache.axis.NoEndPointException();
		}
		...
		_call.setOperationName(new javax.xml.namespace.QName(
				"http://server.webservice.server.genepattern.org",
				"deleteJobOutputFiles"));

		setRequestHeaders(_call);
		setAttachments(_call);
		java.lang.Object _resp = _call.invoke(new java.lang.Object[] {
				new java.lang.Integer(jobId), fileNames });
	...
	public AnalysisJob[] getJobs() throws java.rmi.RemoteException,
			org.genepattern.webservice.WebServiceException {
		if (super.cachedEndpoint == null) {
			throw new org.apache.axis.NoEndPointException();
		}
		...
		_call
				.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
		_call.setOperationName(new javax.xml.namespace.QName(
				"http://server.webservice.server.genepattern.org", "getJobs"));
		...
		if (_resp instanceof java.rmi.RemoteException) {
			...
			try {
				...
				return (AnalysisJob[]) org.apache.axis.utils.JavaUtils.convert(
						_resp, AnalysisJob[].class);
			}
		}
	}
	...
	public java.lang.String getWebServiceName() throws java.rmi.RemoteException {
		...
		_call
				.setOperationName(new javax.xml.namespace.QName(
						"http://webservice.server.genepattern.org",
						"getWebServiceName"));
	...
	public void setEncodingScheme(java.lang.String scheme)
		...
		setAttachments(_call);
		java.lang.Object _resp = _call
				.invoke(new java.lang.Object[] { scheme });
	...
	public void setEncodingSchemeVersion(float version)
		...
		setAttachments(_call);
		java.lang.Object _resp = _call
				.invoke(new java.lang.Object[] { new java.lang.Float(version) });
	...
	public java.lang.String ping() throws java.rmi.RemoteException {
		...
		_call
				.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
		_call.setOperationName(new javax.xml.namespace.QName(
				"http://webservice.server.genepattern.org", "ping"));
