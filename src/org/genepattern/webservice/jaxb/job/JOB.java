...
public class JOB extends MarshallableObject implements Element {
	...
	public static JOB unmarshal(InputStream in) throws UnmarshalException {
		return unmarshal(XMLScanner.open(in));
	}

	public static JOB unmarshal(XMLScanner xs) throws UnmarshalException {
	...
	public int hashCode() {
		...
		h = ((127 * h) + ((_DateSubmitted != null) ? _DateSubmitted.hashCode()
				: 0));
		h = ((127 * h) + ((_DateCompleted != null) ? _DateCompleted.hashCode()
				: 0));
		h = ((127 * h) + ((_InputFilename != null) ? _InputFilename.hashCode()
				: 0));
		h = ((127 * h) + ((_ResultFilename != null) ? _ResultFilename
				.hashCode() : 0));
