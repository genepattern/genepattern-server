...
public class ATTRIBUTE extends MarshallableObject implements Element {
	...
	public static ATTRIBUTE unmarshal(InputStream in) throws UnmarshalException {
		return unmarshal(XMLScanner.open(in));
	}

	public static ATTRIBUTE unmarshal(XMLScanner xs) throws UnmarshalException {
