...
public class OmnigeneErrorCode {
    ...
    static {
        lookuptable.put(Integer.toString(E_OMNIBUS_BUSY) , "Server Busy. Pl try again.");
        lookuptable.put(Integer.toString(E_OMNIBUS_FATAL_ERROR) , "Server Fatal Error");
        lookuptable.put(Integer.toString(E_OMNIBUS_UNRECOGNIZED_VERSION) , "Unregnoized Version");
    }
