...
public class WebServiceException extends Exception
{
    ...
    /**
     * Constructs a new web service exeption when the service needs to throw
     * an exeption and include a message about the "root cause" exception.
     *
     * @param message a <code>String</code> specifying the text of the 
     *                exception message
     ...
     * Constructs a new web service exeption when the service needs to throw
     * an exeption and include a message about the "root cause" exception.
     * The exception's message is based on the localized message of the
