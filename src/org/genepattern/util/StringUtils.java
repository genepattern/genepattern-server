...
public class StringUtils {
    ...
    /**
     * returns a new String where all occurances of the first string are replaced
    ...
    /** counts the number of non-null elements that have a trimed length 
     * of at least 1
     */
