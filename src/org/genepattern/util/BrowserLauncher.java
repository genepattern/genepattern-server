...
public class BrowserLauncher {
	...
	static {
		...
		final String path = org.genepattern.util.GPpropertiesManager
				.getProperty("path.to.browser");
	...
	public static final void main(final String[] args) throws IOException {
		if (System.getProperty("DEBUG") != null)
			System.out.println("Tying to open url with " + browser
					+ " using jvm=" + jvm);
		openURL(args[0]);
		if (System.getProperty("DEBUG") != null)
	...
	public static void openURL(String url) throws IOException {
		...
		case OTHER:
			...
			break;
		case SPECIFIED:
			browser = org.genepattern.util.GPpropertiesManager
					.getProperty("path.to.browser");
			process = Runtime.getRuntime().exec(
					new String[] { (String) browser, url });
