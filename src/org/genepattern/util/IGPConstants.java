...
public interface IGPConstants {
    ...
    public static final String COMMAND_PREFIX = "commandPrefix"; // eg. LSF prefix: bsub -K -o lsf_stdout -e lsf_stderr > & /dev/null
    ...
    public static final int PARAM_INFO_TYPE_NAME_OFFSET = 0; // offset into one of the following array entries
    public static final int PARAM_INFO_TYPE_CLASS_OFFSET = 1;
    public static final String[][] PARAM_INFO_TYPES = { { "text", PARAM_INFO_TYPE_TEXT}, {"integer", PARAM_INFO_TYPE_INTEGER}, {"floating point", PARAM_INFO_TYPE_FLOAT}, { "input file", PARAM_INFO_TYPE_INPUT_FILE } };
    ...
    public static       String[] PARAM_INFO_FILE_FORMAT = { FILE_FORMAT, PARAM_INFO_CHOICE, null };
    public static       String[] PARAM_INFO_DOMAIN = { DOMAIN, PARAM_INFO_CHOICE, null };
    ...
    /** filename of well-known file that may be output by a job, representing the output to the stdout stream of the process */
    public static final String STDOUT = "stdout";
    /** filename of well-known file that may be output by a job, representing the output to the stderr stream of the process */
