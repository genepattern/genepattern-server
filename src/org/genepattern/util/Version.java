...
public class Version {
    ...
    public Version(String release, int major, int minor, int revision, Calendar date, long build) {
        if(release == null) 
        ...
        this.text = release+" "+major+"."+minor+"."+revision+" build="+build+" on "+formater.format(date.getTime());
    }
//    /** test it */
...
//    }
    ...
    public final boolean equals(Version other) {
        if(other != null) {
            return (this.major == other.major && this.minor == other.minor 
                ...
                && this.release.equals(other.release) && this.date.equals(other.date));
        }
        return false;
    }
    ...
    /**
     * the major release number - change here indicating major changes
     * in functionality or internal design 
     */
