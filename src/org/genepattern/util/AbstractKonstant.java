...
/**
 * Subclasses will create instances of all the konstants for a given set
 * This is better than using just any old object because it is more flexable
...
public class AbstractKonstant {
    ...
    public boolean equals(AbstractKonstant other) {
        return ((key == other.key) && (getClass() == other.getClass())
            && (value == value || value != null && value.equals(other.value)));
    }
