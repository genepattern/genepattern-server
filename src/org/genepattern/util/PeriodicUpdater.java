...
/**
 * Periodically fires the execute() method, which is run in a thread, and restarts 
 * the timer only after execute is done.
 * @author  kohm
 */
...
//        }
    ...
    protected final int getDelay() {
        ...
        final int delay = GPpropertiesManager.getIntProperty(prop_key, default_delay);
    ...
    // fields
    /** the key for getting the property that indicates how long to wait 
     * before firing execute() again.
     */
