 ...
 * separate tokens. A token is a maximal sequence of consecutive characters that
 * are not delimiters.
 ...
 * @since JDK1.0
 */
public class ReusableStringTokenizer implements java.util.Enumeration {
	 ...
	 */
	public ReusableStringTokenizer(String str, String delim,
			boolean returnDelims) {
		resetTo(str, delim, returnDelims);
	}
	 ...
	 *            a string to be parsed.
	 */
	public ReusableStringTokenizer(String str) {
		this(str, WHITESPACE, false);
	}

	/** Constructs a ReusableStringTokenizer with out any settings */
	public ReusableStringTokenizer() {
	}

	/**
	 * resets the state to process another String
	 */
	public final void resetTo(String str, String delim, boolean returnDelims) {
		currentPosition = 0;
		newPosition = -1;
		delimsChanged = false;
		this.str = str;
