...
public abstract class SwingWorker {
	...
	public void start() {
		...
		if (t == null)
			throw new org.genepattern.util.Warning(
					"Thread was null did not start");
		t.start();
	}

	/**
	 * starts the thread at a lower or higher relative priority Normaly this
	 * would be a small number -1 or +1 such as: swingworker.start(-1);
	 */
