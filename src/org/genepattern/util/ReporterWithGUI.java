...
public final class ReporterWithGUI extends AbstractReporter {
	...
	public static void main(String[] args) {
		...
		r
				.showError("My Error", "test error message", new Exception(
						"Bogus!!!"));
		System.exit(0);
	}
	...
	public synchronized void showError(String title, String message,
		...
		title = "Error";
		if (th != null) {
			message = "An error of type " + th.getClass().getName()
					+ " occurred.";
		}

		createDialog(title, message, getStackTraceback(th),
	...
	public void showWarning(String title, String message, final Exception w) {
		...
		createDialog(title, message, getStackTraceback(w),
	...
	protected void createDialog(final String title, final String message,
			final String trace, final int type) {
	...
	/**
	 * gets the warnings buffer FIXME this should be transmitting change events
	 * to listeners
	 * 
