...
public final class ReporterNoGUI extends AbstractReporter {
    ...
    /** shows the error message either via dialog if operating as gui 
     * or to file or standard out if no gui.
     */
     ...
     *
     */
    public void showError(final String title, final String message, final Throwable th) {
    ...
    /** shows the warning message optionally via dialog if operating as gui
     * or to file or standard out if no gui.
     */
     ...
     * or to file or standard out if no gui.
     */
    public void showWarning(final String title, final String message, final Exception w) {
        final StringBuffer buf = new StringBuffer();;
        if( title != null ) {
            buf.append(title);
            buf.append('\n');
