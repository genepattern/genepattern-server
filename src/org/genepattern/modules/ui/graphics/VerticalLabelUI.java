...
public class VerticalLabelUI extends BasicLabelUI {
    ...
    private static final double    TOP_DOWN_THETA   = Math.PI/2;//Math.toRadians (90);
    //FIXME broken !!  need bottom up
    private static final double    BOTTOM_UP_THETA  = -TOP_DOWN_THETA;// + Math.PI;//Math.toRadians (270);
...
//    }
    /**
     * this must return the singleton instance of this class as per the swing contract
     * It should not affect the superclass by causing BasicLabelUI.createUI() to return this instance!
     */
    ...
    public static void main(String[] args) {
        ...
        label0.setUI (new VerticalLabelUI ());//l.setUI(new VerticalLabelUI(true));
        ...
        System.out.println("Vertical label size ="+label0.getSize()+" pref="+label0.getPreferredSize ());
        System.out.println("label size ="+label1.getSize()+" pref="+label1.getPreferredSize ());
        System.out.println("label size ="+label2.getSize()+" pref="+label2.getPreferredSize ());
        System.out.println("This frame's content pane has a size of "+ f.getContentPane ().getSize());
    }
}
