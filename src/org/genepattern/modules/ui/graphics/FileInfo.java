...
public class FileInfo {
	...
	/*
	 * 16-bit signed integer (-32768-32767). Imported signed images with any
	 * negative pixel values are converted to unsigned by adding 32768.
	 */
	...
	public String toString() {
		return "name=" + fileName + ", dir=" + directory + ", url=" + url
				+ ", width=" + width + ", height=" + height + ", nImages="
				+ nImages + ", type=" + getType() + ", offset=" + offset
				+ ", whiteZero=" + (whiteIsZero ? "t" : "f") + ", Intel="
				+ (intelByteOrder ? "t" : "f") + ", lutSize=" + lutSize;
	}
