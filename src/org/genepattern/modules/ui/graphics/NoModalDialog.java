...
public class NoModalDialog extends JOptionPane {
	...
	public NoModalDialog(Object message, int messageType, int optionType,
	 ...
	 * and the <code>options</code> parameter is <code>null</code>, then
	 * the options are supplied by the Look and Feel.
	 * <p>
	 * <p>
