...
public class Logo extends javax.swing.JLabel {
	...
	static {
		...
		try {
			InputStream in = ClassLoader
					.getSystemResourceAsStream("com/mprgroup/resources/properties");
			...
			System.err
					.println("Logo static initializer: couldn't load the properties file\n"
							+ ex);
		...
		VERSION_STUFF = "Version " + MAJOR_VERSION + "." + MINOR_VERSION
				+ (REVISION != null ? "." + REVISION : "") + " " + RELEASE
	...
	public void paintComponent(Graphics g) {
		...
		//g.setFont (getFont());
		g.drawString(VERSION_STUFF, (d.width - stringWidth) / 2,
				(d.height * 6) / 10);
	}
