...
/**
 * This represents either a row or a column. Specifically the names and
...
public abstract class AbstractNamesPanel implements NamesPanel {
	...
	public AbstractNamesPanel(final AnnotationFactory annotation,
	...
	/**
	 * returns true if this object can have its' internal state changed through
	 * setters
	 */
	...
	protected final AnnotationFactory internalGetAnnotationFactory() {
		//        if(!is_mutable)
		//            throw new UnsupportedOperationException("Cannot access sensitive
		// object from immutable class!");
		return annotation;
	}
	...
	public boolean equals(Object obj) {
		...
		if (count == panel.getCount() && names != null && others != null) {
			for (int i = 0; i < count; i++) {
				...
				if (!(name == null && other == null || (name != null && name
						.equals(other))))
					return false;
			}
			return true;
