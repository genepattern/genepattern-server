 ...
 * genes and the individual genes' properties. This could also define a list of
 * samples and the individual samples' properties.
 * 
 * @author kohm
 */
public interface FeaturesetProperties extends
		org.genepattern.data.LegendTableModel, DataObjector {
	/** the String representations of the supported column types */
	public static final String[] SUPPORTED_TYPES = new String[] { "int",
			"float", "boolean", "String" };

	/** array of supported classes that coorespond to the SUPPORTED_TYPES */
	public static final Class[] SUPPORTED_CLASSES = new Class[] { Integer.TYPE,
			Float.TYPE, Boolean.TYPE, String.class };
	...
	/**
	 * sets the array values to those of the Column Names if the specified array
	 * is null creates a new String[]
	 * 
	 * @param array
	 *            an array to set or null
	 * @return String[]
	 */
	public String[] getColumnNames(final String[] array);

	/**
	 * sets the specified array values to those of the Column Descriptions if
	 * the specified array is null creates a new String[]
	 * 
	 * @param array
	 *            an array to set or null
	 * @return String[]
	...
	/**
	 * sets the array values to those of the Row Names if the specified array is
	 * null creates a new String[]
	 * 
	 * @param array
	 *            the array to set or null
	 * @return String[]
	 */
