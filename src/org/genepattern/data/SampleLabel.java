...
/**
 * Represents a Sample by name.  This class is comparable to others.
 * It also has a special instance that is equal to any other instance.  This
 * last attribute is needed because cls files do not specify the samples 
 * that they represent.
 *
 * @author  kohm
 */
