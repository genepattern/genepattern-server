...
/**
 * This interface defines what a matrix capabilites will be. There are no
 * setXXX(...) methods. See MatrixMutable for an implementation that is mutable.
...
public interface Matrix extends org.genepattern.data.DataObjector, Serializable {
	 ...
	 */
	public void copySubMatrix(int rowSource, int colSource, int numRow,
			int numCol, int rowDest, int colDest, MatrixMutable target);
