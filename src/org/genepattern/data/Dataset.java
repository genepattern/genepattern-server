...
/**
 *
 * NOT a persistentobject -> algs workoff off this a lot and no need for all
 * the pob gunk. Plus its not really saved - the fixture is.
 *
 * Interface that represents some section of the dataframe -. superset, subset or
 * a combination of some sort.
 * They are immutable.
 *
 * A Math object conceptually similar to R's DataFrame.
