...
public class SomProperties extends DefaultFeaturesetProperties {
	...
	public SomProperties(final String name, final String[] col_names,
			final String[] col_descs, final String[] row_names,
			final String[] row_descs, final Map attributes) {
		super(name, DATA_MODEL.value.toString(), col_names, col_descs,
				row_names, row_descs, attributes);
	}
