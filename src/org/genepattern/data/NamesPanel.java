...
/**
 * The row or column in a dataset including it's description or gene's annotation.
 *
 * @author  kohm
 */
public interface NamesPanel extends org.genepattern.data.DataObjector, Cloneable{
    // fields
     ...
     * @param index the index to the name
     * @return String
     */
     ...
     * @param index the index to the annotation
     * @return String
     */
