...
public class Id implements javax.xml.bind.IdentifiableElement, java.io.Serializable {
     ...
     */
    public Id(String id) {
        if (id.indexOf("\n") != -1) throw new IllegalArgumentException("Ids must not have \n");
        id = id.trim();
        this.fId = id;
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Id) return fId.equals(((Id)obj).fId);
        return false;
    }
