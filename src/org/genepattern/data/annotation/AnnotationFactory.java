...
/**
 * This class produces instances of Annotator. All datasets should have an
 * instance of this.
 * 
 * FIXME there should be a Primary Annotation Factory that creates this one and
 * creates the Annotation instances, preventing duplicates from being stored.
 * 
 * @author kohm
 */
public class AnnotationFactory implements Cloneable {
	...
	/**
	 * Creates a new instance of AnnotationFactory. If the Annotator array is
	 * null or has no elements sets the current Annotator to NoAnnotations.
	 * Otherwise it is set to the first element in the Annotator array.
	 * 
	 * Note perhaps "annots" should be a List of Annotator objects, instead of
	 * an array, so that the list can be maintained by the
	 * PrimeAnnotationFactory (mainly updated with new Annotators as they become
	 * available)
	 * 
	 * @param annots
	 ...
	 * 
	 * @return true if the Annotator was added; false if it was null or already
	 *         present
	 * @param annot
	 ...
	 * 
	 * @param annot
	 *            the annotator to add and set as the current
	...
	/**
	 * sets the current Annotator Note the Annotator does need to be one of the
	 * available Annotators
	 * 
	 * @return true if the Annotator was set; false otherwise
	 * @param annot
	 *            the annotator to set as the current
	 */
