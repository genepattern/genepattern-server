...
/**
 * Classes that implement this interface will know how to annotate Genes by
 * accession number or by other names
 * 
 * @author kohm
 */
public interface Annotator extends org.genepattern.data.DataObjector {
	 ...
	 * 
	 * @param gene
	 *            the feature to get the annotation for
	 ...
	 * 
	 * @param gene
	 *            the array of features to get annotations for
	...
	/**
	 * The annotation's description could be the full text or just parts this is
	 * the capability
	 */
	public static class Capability {
		/**
		 * this is where it all happens Takes the raw annotation and parses it
		 * to produce a subset of info
		 * 
	...
	/**
	 * This class just returns the empty string. This useful when there are no
	...
	static class NoAnnotations implements Annotator {
		 ...
		 * 
		 * @param gene
		 *            the feature to get the description of
		...
		/**
		 * returns all the named gene's descriptions based on the current
		 * capability
		 * 
		 * @param gene
