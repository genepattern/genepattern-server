...
############################################################
# runOnBatch-with-timeout.sh
#   submit job to aws batch, (based on runOnBatch.sh v0.1)
#
# This (example) script uses a bash function to implement job timeout. 
# It may be useful as a reference implementation.
#
# See:
#   gp-timeout.sh
############################################################
