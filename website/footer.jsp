		...
		<tr>
          <td colspan="4" class="footer">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><a href="/gp/pages/about.jsf">About GenePattern</a>&nbsp;|&nbsp;<a href="/gp/pages/contactUs.jsf">Contact Us</a>
                  <br />
                </td>
...
<table height="30" border="0" cellpadding="0" cellspacing="0">
        <tr valign="top">
          <td class="loginsettings2"><a href="/gp/pages/accountInfo.jsf">
			My Settings </a>|<form id="_id99" method="post" action="/gp/logout.jsp" enctype="application/x-www-form-urlencoded" style="display: inline;">
