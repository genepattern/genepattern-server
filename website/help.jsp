...
<title>GenePattern add/update task help</title>
<style>
...
The "run" button gives you the option of running the selected task.
...
<a name="OutputDescription"><h4>Output Description</h4></a>

Select the file format(s) of the output files generated by your task. To select multiple file formats, use CTRL-click. If your task generates an output file format not included in the list, click New to add that format to the list. 
<hr>
...
have more than five files to upload, simply upload the first five, save, edit the task again, and upload more.
