<%@ page import="java.io.BufferedReader, 
		 ...
		 org.genepattern.server.analysis.genepattern.IndexerDaemon,
...
<%
	...
	if (name != null) title = taskInfo.getName();
...
<%
		...
		synchronized (IndexerDaemon.getDaemon().indexLock) { IndexerDaemon.getDaemon().indexLock.notify(); }
...
%>
<%! Thread copyStream(final InputStream is, final JspWriter out, final StringBuffer cc, final boolean DEBUG, final boolean htmlEncode) throws IOException {
