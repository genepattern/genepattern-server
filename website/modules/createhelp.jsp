...
Select the file format(s) of the output files generated by your module. If your module generates an output file format not included in the list, click New to add that format to the list.
<hr>
...
Any files that you upload will appear in the "Current files" section below the download file selectors.
...
If you've mistakenly uploaded files that are not required, or which are no longer necessary, you may select them
from among those listed, and they will be deleted after saving.<br><br>
...
check the prefix when specified box.  If the optional filename is provided, then the flag is added in otherwise the flag is omitted.<br><br>
