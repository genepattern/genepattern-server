...
<ul>
	<li>
		<a name="Name_brief"></a><strong>Name</strong>. Name of the module.</li>
	<li>
		<a name="LSID_brief"></a><strong>LSID</strong>. The Life Science Identifier (LSID) used to uniquely identify a GenePattern module.</li>
	<li>
		<a name="Description_brief"></a><strong>Description</strong>. Brief description of the module.</li>
	<li>
		<a name="Author_brief"></a><strong>Author</strong>. The author&#39;s name and affiliation (company or academic institution).</li>
	<li>
		<a name="Privacy_brief"></a><strong>Privacy</strong>. Modules may be marked as public or private:
		<ul>
			<li>
	...
	<li>
		<a name="Quality_brief"></a><strong>Quality level</strong>. One of three terms that indicates the author&rsquo;s confidence in the robustness of the module: development, preproduction, and production.</li>
	<li>
		<a name="Documentation_brief"></a><strong>Documentation</strong>. Help file that describes the module and provides instructions 
for its use.</li>
	<li>
		<a name="Command_brief"></a><strong>Command line</strong>. Command line used to launch the module. Values enclosed in angle brackets are replaced by specific values before the command executes.</li>
	<li>
		<a name="TaskType_brief"></a><strong>Module category</strong>. Category under which to list this module. Categories are used to organize modules and pipelines on the GenePattern home page. Pipelines are always assigned to the category name <em>pipeline</em>.</li>
	<li>
		<a name="cpu_brief"></a><strong>CPU type</strong>. Indicates the type of CPU required to run the module, or <em>any</em> if the module runs on any type of CPU.</li>
	<li>
		<a name="os_brief"></a><strong>Operating system</strong>. Indicates the operating system required to run the module, or <em>any</em> if the module runs on any operating system.</li>
	<li>
		<a name="Language_brief"></a><strong>Language</strong>. Indicates the programming language used to implement the module.</li>
	<li>
		<a name="MinLanguage_brief"></a><strong>min. language version</strong>. Indicates the version of the programming language used to implement the module.</li>
	<li>
		<a name="VersionComment_brief"></a><strong>Version comment</strong>. Describes changes made to the module in this version.</li>
	<li>
		<a name="FileFormat_brief"></a><strong>File format(s)</strong>. Lists the file formats of any output files generated by the module.</li>
	<li>
		<a name="Files_brief"></a><strong>Current files</strong>: Lists the support files packaged with the module, such as executable programs, documentation, and so on.</li>
	<li>
		<a name="Parameters_brief"></a><strong>Parameters</strong>: Lists the module parameters, including the file formats of any input files required by the module.</li>
</ul>
