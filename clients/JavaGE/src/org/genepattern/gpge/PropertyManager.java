...
public class PropertyManager {
    ...
    /**
     * Sets the given property. The change is not persisted until saveProperties
     * is called. If <tt>value</tt> is <tt>null</tt>, then the default
     * value for the given property is used.
     * 
     * @param name
     *            the property name
     * @param value
    ...
    private static void loadProperties(Properties into, InputStream in) throws IOException {
        try {
            into.load(in);
        } finally {
            in.close();
