...
/**
 * Default implementation of the DataObjectProxy interface. This class is a
 * Proxy for a DataObject. It can return the summary information about the
 * object. If getDataObject() is called the actual DataObject is loaded from the
 * DataSource.
 * 
 * @author kohm
 */
public class DefaultDataObjectProxy extends AbstractObject implements
		DataObjectProxy {

	/** Creates a new instance of DefaultDataObjectProxy */
	public DefaultDataObjectProxy(final String name, final DataSource source,
	 ...
	 *                if the data object cannot be retrived from its' source
	 * @exception IllegalArgumentException
	 *                if the data source no longer has the DataObject
	 */
	public DataObjector getDataObject() throws java.io.IOException,
			java.text.ParseException, IllegalArgumentException {
		if (data_object == null)
	...
	public boolean equals(Object obj) {
		...
		return (getName().equals(other.getName())
				&& getDataModel().equals(other.getDataModel()) && getSummaryInfo()
				.equals(other.getSummaryInfo()));
	}
