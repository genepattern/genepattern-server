...
/**
 * Implementations of this interface will be able to get the data object on
 * demand or simply display some basic or Summaryinfo details without loading
...
public interface DataObjectProxy extends DataObjector {
	 ...
	 * 
	 * @exception if
	 *                the data obect cannot be retrived from its' source at this
	 *                time
	 */
