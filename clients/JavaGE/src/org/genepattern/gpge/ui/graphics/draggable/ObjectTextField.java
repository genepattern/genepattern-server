...
public class ObjectTextField extends javax.swing.JTextField {
	...
	private void initComponents() {//GEN-BEGIN:initComponents
		...
		setEditable(false);
		setBorder(new javax.swing.border.EtchedBorder(java.awt.Color.darkGray,
	...
	/**
	 * sets the String representation of the type that this Component accepts as
	 * a Drop
	 */
	...
	protected void indicateBadDrop() {
		if (bad_border == null)
			bad_border = new EtchedBorder(java.awt.Color.darkGray,
					java.awt.Color.red);
	...
	protected void indicateGoodDrop() {
		if (good_border == null)
			good_border = new EtchedBorder(java.awt.Color.darkGray,
	...
	/**
	 * the String representation of the type that this Component accepts as a
	 * Drop
	 */
	private String type;

	/** normal border */
	private EtchedBorder normal_border = new EtchedBorder(
			java.awt.Color.darkGray, java.awt.Color.orange);
	...
	class ObjectDropTargetListener implements java.awt.dnd.DropTargetListener {
		...
		public final void dragEnter(final DropTargetDragEvent e) {
			...
			if (!isDragAcceptable(e)) {
				...
				System.out.println("Accepted drop from source: "
						+ e.getSource());
				indicateGoodDrop();
			}
		}
		...
		public final boolean isDropAcceptable(final DropTargetDropEvent e) {
			...
			if (!is_acceptable) {
				...
				//edu.mit.genome.debug.FieldDumper.printArray(e.getCurrentDataFlavors(),
				// System.out, "\n");
				return false;
			}
			return true;
		...
		protected final boolean isDataFlavorSupported(
			...
			if (e
				...
				//try {
				//	List files =
				// (List)transferable.getTransferData(java.awt.datatransfer.DataFlavor.javaFileListFlavor);
