...
public class SortTreeModel extends javax.swing.tree.DefaultTreeModel {
	...
	/**
	 * Invoked this to insert newChild into parent and it will be sorted. Note
	 * that the <CODE>index</CODE> parameter is ignored Use the
	 * insertNodeInto(MutableTreeNode newChild, MutableTreeNode parent) instead
	 */
	...
	/**
	 * Invoked this to insert a newChild node into the parent and its' position
	 * will be proper for being sorted.
	 */
