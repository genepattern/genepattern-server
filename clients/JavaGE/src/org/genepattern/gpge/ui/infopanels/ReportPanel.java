...
public class ReportPanel extends javax.swing.JPanel {
    ...
    public ReportPanel(final URL preamble, final StringBuffer buffer)
        ...
        // ge.getScreenDevices()[0].getConfigurations()[0];
    ...
    /**
     * clears all text from the textArea is equivalent to select all, then cut
     * operations
     */
    ...
    private void createBugReport(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_copy
        ...
        java.net.URL url = ReportPanel.class
                .getResource("/edu/mit/genome/gp/resources/Error_preamble.html");

        SendMailPanel mail_panel = new SendMailPanel();

        Object[] options = { "Send", "Cancel" };
        int result = JOptionPane.showOptionDialog(
                GenePattern.getDialogParent(), mail_panel, "Bug Report",
        ...
        java.util.TreeMap tmProps = new java.util.TreeMap(System
                .getProperties());
        StringBuffer propsBuffer = new StringBuffer();
        for (java.util.Iterator iProps = tmProps.keySet().iterator(); iProps
                .hasNext();) {
        ...
        String info = BuildProperties.PROGRAM_NAME + " "
        ...
        try {
            ...
            String address = PropertyManager.getProperty("gp.mail.helpAddress");
