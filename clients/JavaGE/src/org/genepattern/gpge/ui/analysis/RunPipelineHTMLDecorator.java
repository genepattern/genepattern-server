 ...
 */
	...
	protected String localizeURL(String original) {
		...
		original = GenePatternAnalysisTask.replace(original, GPConstants.LEFT_DELIMITER + GPConstants.LSID + GPConstants.RIGHT_DELIMITER, model.getLsid());
		original = GenePatternAnalysisTask.replace(original, GPConstants.LEFT_DELIMITER + GENEPATTERN_PORT + GPConstants.RIGHT_DELIMITER, port);
		original = GenePatternAnalysisTask.replace(original, GPConstants.LEFT_DELIMITER + GENEPATTERN_URL + GPConstants.RIGHT_DELIMITER, System.getProperty("GenePatternURL"));
		try {
			// one of ours?
