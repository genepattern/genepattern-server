...
import org.genepattern.gpge.ui.analysis.jaxb.*;
 ...
 * <p>Description: Used to serialize and de-serialize between DataModel and XML file</p>
 * @author Hui Gong
 * @version 1.0
 */
...
public class DataHandler {
    ...
    /**
     * Gets XML string from <code>DataModel<code>, only history and result will be converted to XML
     * @param model DataModel for the analysis UI
     * @return XML string
     * @throws IOException
     * @throws StructureValidationException
     */
    public static String getXML(DataModel model) throws StructureValidationException, IOException{
     ...
     * @throws StructureValidationException
     */
    public static void saveData(DataModel model, String fileName) throws IOException, StructureValidationException{
     ...
     */
    public static DataModel loadDate(String filename) throws FileNotFoundException, UnmarshalException{
     ...
     * @throws UnmarshalException
     */
    public static DataModel loadData(File file) throws FileNotFoundException, UnmarshalException{
        ...
        while(hisIt.hasNext()){
            ...
            //System.out.println("Job ID: "+jobInfo.getJobNumber()+" Submitted: "+jobInfo.getDateSubmitted());
            AnalysisJob analysisJob = new AnalysisJob(jobHistory.getSiteName(), jobHistory.getTaskName(), jobInfo);
    ...
    private static JobInfo jobToJobInfo(Job job){
        ...
        if(!completedTime.equals("")) jobInfo.setDateCompleted(new Date(Long.parseLong(completedTime)));
        String submittedTime = job.getDateSubmitted();
        if(!submittedTime.equals("")) jobInfo.setDateSubmitted(new Date(Long.parseLong(submittedTime)));
