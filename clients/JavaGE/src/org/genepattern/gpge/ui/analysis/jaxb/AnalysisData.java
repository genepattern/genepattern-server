...
public class AnalysisData extends MarshallableRootElement implements
		RootElement {

	private List _Result = PredicatedLists.createInvalidating(this,
			new ResultPredicate(), new ArrayList());

	private PredicatedLists.Predicate pred_Result = new ResultPredicate();

	private List _History = PredicatedLists.createInvalidating(this,
			new HistoryPredicate(), new ArrayList());
	...
	public void emptyResult() {
		_Result = PredicatedLists.createInvalidating(this, pred_Result,
				new ArrayList());
	}
	...
	public void emptyHistory() {
		_History = PredicatedLists.createInvalidating(this, pred_History,
				new ArrayList());
	}
	...
	public void unmarshal(Unmarshaller u) throws UnmarshalException {
		...
		{
			List l = PredicatedLists
					.create(this, pred_History, new ArrayList());
			while (xs.atStart("History")) {
				l.add(((History) u.unmarshal()));
			}
			_History = PredicatedLists
					.createInvalidating(this, pred_History, l);
		}
	...
	private static class ResultPredicate implements PredicatedLists.Predicate {
	...
	private static class HistoryPredicate implements PredicatedLists.Predicate {
