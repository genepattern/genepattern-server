...
public class History extends MarshallableObject implements Element {
	...
	public static History unmarshal(InputStream in) throws UnmarshalException {
		return unmarshal(XMLScanner.open(in));
	}

	public static History unmarshal(XMLScanner xs) throws UnmarshalException {
