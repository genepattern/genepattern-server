...
public class Result extends MarshallableObject implements Element {

	private String _SiteName;

	private String _TaskName;

	private List _Job = PredicatedLists.createInvalidating(this,
			new JobPredicate(), new ArrayList());
	...
	public void emptyJob() {
		_Job = PredicatedLists.createInvalidating(this, pred_Job,
				new ArrayList());
	}
	...
	public static Result unmarshal(InputStream in) throws UnmarshalException {
		return unmarshal(XMLScanner.open(in));
	}

	public static Result unmarshal(XMLScanner xs) throws UnmarshalException {
	...
	private static class JobPredicate implements PredicatedLists.Predicate {
