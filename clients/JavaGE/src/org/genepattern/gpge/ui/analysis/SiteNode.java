...
/**
 * <p>Title: SiteNode.java </p>
 * <p>Description: A tree node for analysis service site. </p>
 * @author Hui Gong
 * @version 1.0
 */
    ...
    public JPopupMenu getPopup(){
        ...
        delete.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent ae){
                ...
                DefaultMutableTreeNode parent = (DefaultMutableTreeNode)SiteNode.this.getParent();
                if(SiteNode.this.getChildCount()!=0){
                    int type = JOptionPane.showConfirmDialog(null, "Do you want to delete all results under "+siteName+"?");
                    if(type==JOptionPane.OK_OPTION){
                        SiteNode.this._dataModel.removeSiteFromResult(siteName);
                        parent.remove(SiteNode.this);
                        ((DefaultTreeModel)SiteNode.this._treeModel).nodeStructureChanged(SiteNode.this);
                    }
                }
                else{
                    SiteNode.this._dataModel.removeSiteFromResult(siteName);
