...
public class JavaGELocalTaskExecutor extends LocalTaskExecutor {
	...
	public JavaGELocalTaskExecutor(DataObjectBrowser dataObjectBrowser, TaskInfo taskInfo, Map paramName2ValueMap, String userName, String server) throws java.io.IOException, java.net.MalformedURLException {
	...
	public void exec() throws RunTaskException {
		try {
			...
			if(e.getCause() instanceof org.apache.axis.AxisFault) {
				org.apache.axis.AxisFault fault = (org.apache.axis.AxisFault) e.getCause();
