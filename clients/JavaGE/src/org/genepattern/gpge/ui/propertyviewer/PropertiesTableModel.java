...
/**
 * Thin wrapper for a Properties object. Thus properties can be displayed in a
 * table, sorted, and optionaly the values can be editted.
 * 
 * @author kohm
 */
public class PropertiesTableModel extends javax.swing.table.AbstractTableModel {
	...
	public PropertiesTableModel(final Properties properties,
			final boolean is_value_editable) {
	...
	/**
	 * determines if a cell is editable only the value column could be
	 */
