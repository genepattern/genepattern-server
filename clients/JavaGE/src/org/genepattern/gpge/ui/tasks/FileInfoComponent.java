...
public class FileInfoComponent extends JLabel {
   ...
   public void select(java.net.URLConnection conn, String name) throws IOException {
      if(conn == null) {
         setText("");
         return;
      }
   ...
   static class FileSummaryReader {
      ...
      public static String getKind(InputStream is, String name) throws IOException {
      ...
      public static String[] getSummary(InputStream is, String name) throws IOException {
