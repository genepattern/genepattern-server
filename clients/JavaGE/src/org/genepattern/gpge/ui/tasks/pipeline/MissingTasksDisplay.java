...
public class MissingTasksDisplay {
    ...
    public MissingTasksDisplay(final List missingTasks,
        ...
        missingTasksPanel = new JPanel(new FormLayout(
                "left:pref, 3dlu, left:pref, 3dlu, left:pref", rowSpec
                        .toString()));
        ...
        for (int i = 0, size = missingTasks.size(); i < size; i++) {
            ...
            try {
                missingTasksPanel.add(new JLabel(new LSID(js.getLSID())
                        .getVersion()), cc.xy(3, i + 2));
            } catch (MalformedURLException e) {
                e.printStackTrace();
            }
            ...
            public void actionPerformed(ActionEvent arg0) {
                new CLThread() {
                    ...
                    public void run() {
                        ...
                        final JDialog dialog = new CenteredDialog(GenePattern
                                .getDialogParent());
                        final JLabel label = new JLabel(
                                "Preparing to install tasks...", JLabel.CENTER);
                        ...
                        try {
                            ...
                            ActionListener btnListener = new ActionListener() {
                                ...
                                public void actionPerformed(ActionEvent e) {
                                    if (e.getSource() == cancelButton) {
                                        label
                                                .setText("Cancelling Installation...");
                                        cancel = true;
                                    } else {
                                        dialog.dispose();
                                    }
                            ...
                            if (!GenePattern.disconnectedFromServer(e1)) {
                                GenePattern
                                        .showErrorDialog("An error occurred while installing the missing modules.");
                            }
