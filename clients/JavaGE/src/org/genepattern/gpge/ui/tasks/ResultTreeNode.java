...
/**
 * <p>
 * Title: ResultTreeNode.java
 * </p>
 * <p>
 * Description: Class ResultTreeNode is the super class for all tree node in the
 * result tree.
 * </p>
 * 
 * @author Hui Gong
...
public abstract class ResultTreeNode extends DefaultMutableTreeNode {
	...
	public ResultTreeNode(Object userObject, DataModel data,
			TreeModel treeModel, final boolean allows_childern) {
