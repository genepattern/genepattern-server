 ...
 * 
 * <p>
 * Description: Table model for the HistoryPanel
 * </p>
 * 
 * @author Hui Gong
 * @version $Revision$
...
public class HistoryTableModel extends AbstractTableModel {
	private final String[] columnNames = { "Job ID", "Type", "Time Submitted",
			"Time Completed", "Status", "Service Site" };
	...
	private static Category cat = Category.getInstance(HistoryTableModel.class
			.getName());
	 ...
	 *            a list of JobInfo objects
	 * @param site_name
	 *            the name of the site whos jobs will be displayed or null to
	 *            display all
	 */
	...
	public void remove(int[] selectedRows) {
		for (int i = 0; i < selectedRows.length; i++) {
			_jobs.remove(selectedRows[i] - i); // subtract i b/c remove shifts
