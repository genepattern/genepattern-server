...
public class TaskNamePanel extends JPanel {
	...
	public TaskNamePanel(TaskInfo taskInfo, final int type,
		...
		JComboBox versionComboBox = new VersionComboBox((String) taskInfo.getTaskInfoAttributes().get(GPConstants.LSID), type);
		...
		JPanel temp = new JPanel(new FormLayout(
				"left:pref:none, 3dlu, pref", "pref")); // title, version

		temp.add(taskNameComponent, cc.xy(1, 1));
		temp.add(versionComboBox, cc.xy(3, 1));
