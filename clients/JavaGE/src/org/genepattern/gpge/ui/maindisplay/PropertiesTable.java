 ...
 * @author kohm
 */
public class PropertiesTable extends
		org.genepattern.modules.ui.graphics.BaseTable
		/* javax.swing.JTable */implements DataSelectListener {
	...
	protected void setAttributes(final Map attrs) {
		...
		for (final Iterator iter = keyset.iterator(); iter.hasNext();) {
			...
			rowData[0] = name;
			rowData[1] = value;
			//rowData[1] = (value instanceof Object[]) ? ((Object)new
			// JList((Object[])value)) : value;
	...
	public void dataSourceSelected(final GroupDataSource source,
		...
		} else if (source instanceof org.genepattern.gpge.io.DirDataSource) { //project
																			  // dir
	...
	static class ArrayRenderer extends
		...
		public final void setValue(final Object value) {
			...
			if (value instanceof String[]) {
				text = org.genepattern.util.ArrayUtils
