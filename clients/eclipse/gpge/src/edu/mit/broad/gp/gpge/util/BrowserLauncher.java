 ...
 */
package edu.mit.broad.gp.gpge.util;
...
public class BrowserLauncher {
	...
	private static final int MAC_OSX = 7;
	...
	private static Object locateBrowser() {
        ...
        public static final void main(final String[] args) throws IOException{
            if (System.getProperty("DEBUG") != null) System.out.println("Tying to open url with "+browser+" using jvm="+jvm);
            openURL(args[0]);
            if (System.getProperty("DEBUG") != null) System.out.println("Java done!");
        }
	/**
	...
	public static void openURL(String url) throws IOException {
		...
		// state info 
		if (DEBUG) {
	                System.out.println("BrowserLauncher:");
	                System.out.println("jvm="+jvm);
	                System.out.println("browser="+browser);
	                System.out.println("openURL"+openURL);
	                System.out.println("loadedWithoutErrors="+loadedWithoutErrors);
		}
                // end state info
		switch (jvm) {
			case MAC_OSX:
			...
			case OTHER:
				...
				// First, attempt to open the URL in a currently running session of Netscape
                            	if (DEBUG) System.out.println("Assuming Netscape Web Browser");
				...
				try {
					...
					if (exitCode != 0) {	// if Netscape was not open
                                            ...
                                            if (exitCode != 0) {	// if Netscape was not available
                                                if (DEBUG) System.out.println("Assuming Mozilla Web Browser");
             ...
             /*           case SPECIFIED:
                       browser = edu.mit.genome.util.GPpropertiesManager.getProperty("path.to.browser");
                        process = Runtime.getRuntime().exec(new String[] { (String) browser, url});
