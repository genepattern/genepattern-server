...
jarFiles = char('jakarta-oro-2.0.8.jar','broad-cg.jar','Jama-1.0.1.jar',...
    'MAGEstk-2003-10-24-v1.1-compatible.jar','trove.jar',...
    'activation.jar','axis.jar','GenePattern.jar','commons-codec-1.3.jar',...
    'commons-discovery-0.2.jar','commons-httpclient-3.0.1.jar','commons-logging-1.0.4.jar',...
    'gpwebservice.jar','jaxb-rt-1.0-ea.jar','jaxrpc.jar','log4j-1.2.11.jar',...
    'mail.jar','saaj.jar');
