...
jarFiles = char('jakarta-oro-2.0.8.jar','broad-cg.jar','Jama-1.0.1.jar',...
    ...
    'activation.jar','analysis.jar','axis.jar','GenePattern.jar',...
    'commons-discovery.jar','commons-logging.jar',...
    'gpwebservice.jar','jaxb-rt-1.0-ea.jar','jaxrpc.jar','log4j-1.2.4.jar',...
    'mail.jar','saaj.jar');
