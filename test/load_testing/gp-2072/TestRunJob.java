 ...
 *
 * After running this program (which executes two GenePattern jobs on the server),
...
public class TestRunJob {
    ...
    public static void main(String[] args) {
        String server = "http://node256.broad.mit.edu:8080";
        ...
        //System.out.println("Connecting to "+server+" as "+username);
