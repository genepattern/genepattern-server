...
/**
 * junit tests for setting a custom lsf hostname(s) with the original (<= 3.8.1) LsfCommandExecutor.
 * @author pcarr
 *
 */
public class TestCustomHostnames {
    @Test
    public void customLsfHostnames() {
        ...
        jobProps.put("lsf.hostname", "node1448 node1449");
